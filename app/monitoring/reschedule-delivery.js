...
const rescheduleDelivery = async (delivery) => {
  ...
  try {
    ...
    const personalisation = { schemeName: statement.schemeName, schemeShortName: statement.schemeShortName, schemeYear: statement.schemeYear, schemeFrequency: statement.schemeFrequency.toLowerCase(), businessName: statement.businessName }
