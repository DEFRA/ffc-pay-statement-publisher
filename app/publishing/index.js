...
const publishStatement = async (request) => {
  const personalisation = { schemeName: request.scheme.name, schemeShortName: request.scheme.shortName, schemeYear: request.scheme.year, schemeFrequency: request.scheme.frequency.toLowerCase(), businessName: request.businessName }
