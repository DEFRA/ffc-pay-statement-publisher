...
describe('Publish document', () => {
  ...
  describe('Validate request', () => {
    describe.each([
      { name: 'statement', request: JSON.parse(JSON.stringify(require('../../mocks/messages/publish').STATEMENT_REQUEST)), expected: undefined },
      { name: 'schedule', request: JSON.parse(JSON.stringify(require('../../mocks/messages/publish').SCHEDULE_REQUEST)), expected: undefined }
